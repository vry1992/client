...
export const personNameAndInitialsRegexp = /^([А-Яа-я]+)\s([А-Я]\.[А-Я]\.)$/;
...
export const errorFrequency = 'Не коректне значення. Має бути 0000 для КХ діапазону та 000.0 / 000.00 / 000.000 для УКХ діапазону';
